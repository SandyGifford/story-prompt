const { commonPaperTemplateStoryGen } = require("../src/storyGen");
...
describe("storyGen", () => {
	describe("basic template", () => {
		test("normal usage", () => {
			expect(commonPaperTemplateStoryGen(BASIC_TEMPLATE, "3", "miles", "school", "blue", "rock"))
		...
		test("almost-to-long-strings", () => {
			expect(commonPaperTemplateStoryGen(BASIC_TEMPLATE, 3, "12345678901234567890", "school", "blue", "rock"))
				.toBe("One day Anna was walking her 3 12345678901234567890 commute to school and found a blue rock on the ground.");
			expect(commonPaperTemplateStoryGen(BASIC_TEMPLATE, 3, "12345678901234567890", "school", "blue", "12345678901234567890"))
			...
			// expect(commonPaperTemplateStoryGen(BASIC_TEMPLATE, 12345678901234567890, "12345678901234567890", "school", "blue", "12345678901234567890"))
			...
			expect(commonPaperTemplateStoryGen(BASIC_TEMPLATE, Number.MAX_VALUE, "12345678901234567890", "school", "blue", "12345678901234567890"))
			...
			expect(commonPaperTemplateStoryGen(BASIC_TEMPLATE, Number.MAX_SAFE_INTEGER, "12345678901234567890", "school", "blue", "12345678901234567890"))
		...
		describe("error cases", () => {
			test("non-numeric values for number", () => {
				expect(() => commonPaperTemplateStoryGen(BASIC_TEMPLATE, "hello world", "mile", "school", "blue", "rock")).toThrow();
				expect(() => commonPaperTemplateStoryGen(BASIC_TEMPLATE, "", "mile", "school", "blue", "rock")).toThrow();
				expect(() => commonPaperTemplateStoryGen(BASIC_TEMPLATE, "-", "mile", "school", "blue", "rock")).toThrow();
				expect(() => commonPaperTemplateStoryGen(BASIC_TEMPLATE, "-+", "mile", "school", "blue", "rock")).toThrow();
				expect(() => commonPaperTemplateStoryGen(BASIC_TEMPLATE, "NaN", "mile", "school", "blue", "rock")).toThrow();
				expect(() => commonPaperTemplateStoryGen(BASIC_TEMPLATE, NaN, "mile", "school", "blue", "rock")).toThrow();
			});

			test("long strings", () => {
				expect(() => commonPaperTemplateStoryGen(BASIC_TEMPLATE, 3, "123456789012345678901", "school", "blue", "rock")).toThrow(AssertionError);
				expect(() => commonPaperTemplateStoryGen(BASIC_TEMPLATE, 3, "123456789012345678901", "school", "123456789012345678901", "rock")).toThrow(AssertionError);
			});
		});
	});
});
